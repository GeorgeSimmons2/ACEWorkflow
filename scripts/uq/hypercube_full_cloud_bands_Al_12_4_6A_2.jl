...
pr_f = committee_predictions_fast(model, mem_full, TEST; stride=stride, point_params=θ_mean,
                             per_atom=true)
pr_3 = committee_predictions_fast(model, mem_30,   TEST; stride=stride, point_params=θ_mean,
                             per_atom=true)
