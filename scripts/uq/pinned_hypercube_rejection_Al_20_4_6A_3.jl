...
fig = Figure(size=(590, 260), figure_padding=(7,10,4,7))
...
panel(fig[1,1], F_n, unst_n, "Constrained lattice constant", GRY)
ax2 = panel(fig[1,2], F_r, unst_r, "Constrained lattice constant and rejection", GRN)
ax2.ylabel = ""
