...
for i = 12:20
    # percent = 5
    model_name, model_dir, _, _ = build_model(:Al, i, 4, 6.0, 3; training_xyz="/storage/astro2/phupfb/PhD/acestuff/ACEWorkflow/data/Al/manual_df_train_Al.extxyz", dataset_name = "")
end
