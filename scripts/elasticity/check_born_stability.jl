function make_Al_fcc_unit_cell(lattice)
    # a = a*u"Å"  # Al lattice constant (you can also rely on input lattice)
    ...
    atoms = [AtomsBase.Atom(:Al, pos) for pos in cartesian_positions]
...
a = ACEWorkflow.relax_lattice_constant(model, :Al)
cell_vectors = (
    SVector(a,0,0)*u"Å",
    SVector(0,a,0)*u"Å",
    SVector(0,0,a)*u"Å"
