# gruneisen_Al_16_4_6A_3.jl
#
# Grüneisen parameter for Al_16_4_6A_3, across the two ensembles from
...
# scripts/qoi/gruneisen_committee.jl, so every model's version of this QoI stays identical in method.
#
...
#
# Run:  julia --project -t <ncores> scripts/qoi/gruneisen_Al_16_4_6A_3.jl
...
isempty(ARGS) || error("""
    ...
    Use scripts/qoi/gruneisen_committee.jl directly for different ones.""")

include(joinpath(@__DIR__, "gruneisen_committee.jl"))
