...
SURFACE   = "111"#get(ENV, "SURFACE", "001")
SRC       = "models/Al_20_4_6A_3_/results/pinned_hypercube_rejection/surface_energy"#get(ENV, "SRC", "models/Al_12_4_6A_2_/results/surface_energy")
