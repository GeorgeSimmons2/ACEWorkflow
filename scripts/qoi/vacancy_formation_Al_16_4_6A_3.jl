# vacancy_formation_Al_16_4_6A_3.jl
#
# Vacancy formation energy for Al_16_4_6A_3, across the two ensembles from
...
# scripts/qoi/vacancy_formation.jl, so every model's version of this QoI stays identical in method.
#
...
#
# Run:  julia --project -t <ncores> scripts/qoi/vacancy_formation_Al_16_4_6A_3.jl
...
for (k, v) in ("MODELDIR"    => MD16,
               ...
               "OUTDIR"      => "$SRC16/vacancy_formation")
...
isempty(ARGS) || error("""
    ...
    Use scripts/qoi/vacancy_formation.jl directly for different ones.""")

include(joinpath(@__DIR__, "vacancy_formation.jl"))
