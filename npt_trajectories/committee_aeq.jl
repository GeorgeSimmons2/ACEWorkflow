# ─────────────────────────────────────────────────────────────────────────────
# PINNED REPRODUCTION COPY of scripts/uq/bandpath_committee_undotted_Al_12_4_6A_2.jl
#
...
# [REPRO] fresh by default; the published committee is bandpath_undotted
outdir = get(ENV, "COMMITTEE_OUT", "$(result.dir)/results/repro_bandpath_undotted"); mkpath(outdir)
